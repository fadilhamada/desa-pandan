<?php
    ...
    if(isset($_POST['submit'])) {
        if(createJabatan($_POST) > 0) {
            echo "<script>
                    alert('Data bahasil ditambah');
        ...
        <div class="px-5 py-2">
            ...
            <form action="" method="POST">
                <div class="mb-5">
                    ...
                    <input type="text" name="jabatan" id="jabatan" class="border px-3 py-1 rounded-md w-full outline-none" placeholder="Masukkan jabatan" required>
                </div>
