<?php
    ...
    $data = jabatan("SELECT * FROM galeri WHERE id = $id")[0];

    if(isset($_POST['submit'])) {
        if(editGaleri($_POST, $id) > 0) {
            echo "<script>
    ...
    <div class="w-full pt-16" id="margin">
        <div class="px-5 py-2">
            <div class="font-bold py-3 text-base flex gap-3 mb-3">
                ...
                <p>></p>
                <a href="/web-desa/admin-desa/galeri.php">Galeri</a>
                <p>></p>
                <h1 class="text-[#06D001]">Edit data</h1>
            </div>
            <form action="" method="POST" enctype="multipart/form-data">
                <div class="mb-5">
                    ...
                    <input type="text" name="keterangan" id="keterangan" class="border px-3 py-1 rounded-md w-full outline-none" placeholder="Keterangan gambar" value=<?= $data['keterangan'] ?> required>
                </div>
                <div class="mb-5">
                ...
                <div class="flex justify-end gap-4">
                    ...
                    <a href="/web-desa/admin-desa/galeri.php" class="bg-red-500 text-white px-3 py-2 rounded-md shadow-md">Kembali</a>
                </div>
            </form>
        </div>
    </div>
