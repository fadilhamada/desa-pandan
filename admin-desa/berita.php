    ...
    <div class="w-full pt-16" id="margin-toggle">
        <div class="px-5 py-2">
            <div class="font-bold py-3 flex gap-3 mb-3">
                ...
                <p>></p>
                <h1 class="text-[#06D001]">Berita</h1>
            </div>
                ...
                <table class="text-sm text-left w-full mb-5">
                    ...
                    <tr class="bg-white border-b border-black">
                        ...
                        <td class="px-3 py-4 text-white">
                           ...
                           <button class="px-2 py-1 rounded-md" id="red"><a href="berita/hapus-berita.php?id=<?= $b['id']; ?>" onclick="return confirm('Apakah anda akan mengapus data tersebut?');">Hapus</a></button>
                        </td>
                    </tr>
                    <?php $i++; ?>
                    <?php endforeach; ?>
