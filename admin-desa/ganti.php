...
if(isset($_POST['submit'])) {
    if(change($_POST, $_SESSION['username']) > 0) {
        echo "<script>
    ...
    <div class="w-full pt-16" id="margin">
        <div class="px-5 py-2">
            ...
            <form action="" method="POST" enctype="multipart/form-data">
                <div class="mb-5">
                    <label for="pass" class="block mb-2">Password baru</label>
                    <input type="text" name="pass" id="pass" class="border px-3 py-1 rounded-md w-full outline-none" placeholder="Masukkan username" required>
                </div>
                <div class="mb-5">
                    <label for="pass2" class="block mb-2">Konfirmasi password</label>
                    <input type="text" name="pass2" id="pass2" class="border px-3 py-1 rounded-md w-full outline-none" placeholder="Masukkan username" required>
                </div>
