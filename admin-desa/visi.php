    ...
    <div class="w-full pt-16" id="margin-toggle">
        <div class="px-5 py-2">
            <div class="font-bold py-3 flex gap-3 mb-3">
                ...
                <p>/</p>
                <h1 class="text-[#06D001]">Visi desa</h1>
            </div>
            <div class="margin-top">
                <a href="/web-desa/admin-desa/visi/post-visi.php" class="px-4 py-2 bg-blue-500 font-semibold text-white rounded-md" id="tambah">Tambah Data</a>
                ...
                <table class="text-sm text-left w-full">
                    ...
                    <tr class="bg-white border-b border-black">
                        ...
                        <td class="px-3 py-4 text-white">
                           <button class="px-2 py-1 rounded-md" id="blue"><a href="visi/edit-visi.php?id=<?= $b['id']; ?>">Edit</a></button>
                           <button class="px-2 py-1 rounded-md" id="red"><a href="visi/hapus-visi.php?id=<?= $b['id']; ?>" onclick="return confirm('Apakah anda akan mengapus data tersebut?');">Hapus</a></button>
                        </td>
                    </tr>
                    <?php $i++; ?>
                    <?php endforeach; ?>
