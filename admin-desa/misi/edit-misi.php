<?php
    ...
    $data = jabatan("SELECT * FROM misi WHERE id = $id")[0];
    ...
    if(isset($_POST['submit'])) {
        ...
        if(!$deskripsi || $deskripsi == "") {
            echo "<script>
                    ...
                    document.location.href = 'edit-misi.php';
                </script>";
            return false;
        }
        ...
        $query = "UPDATE misi SET deskripsi = ? WHERE id = ?";
    ...
    <div class="w-full pt-16" id="margin">
        <div class="px-5 py-2">
            <div class="font-bold py-3 text-base flex gap-3 mb-3">
                ...
                <p>/</p>
                <a href="/web-desa/admin-desa/visi.php">Misi desa</a>
                <p>/</p>
            ...
            <form action="" method="POST">
                ...
                <div class="flex justify-end gap-4">
                    ...
                    <a href="../misi.php" class="bg-red-500 text-white px-3 py-2 rounded-md shadow-md">Kembali</a>
                </div>
            </form>
        </div>
    </div>
