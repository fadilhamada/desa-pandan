        ...
        <div class="px-5 py-2">
            ...
            <form action="" method="POST" enctype="multipart/form-data">
                <div class="mb-5">
                    ...
                    <input type="text" name="nama" id="nama" class="border px-3 py-1 rounded-md w-full outline-none" placeholder="Masukkan jabatan" required>
                </div>
                <div class="mb-5">
