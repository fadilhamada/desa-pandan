<?php
    ...
    $data = jabatan("SELECT * FROM potensi ORDER BY id DESC");
...
<title>Potensi Desa | Web Desa Pandan</title>
...
<div class="max-w-full bg pt-24">
    <div class="px-7 lg:px-20">
        <div class="flex items-center gap-3 font-semibold">
            ...
            <p>/</p>
            <p class="text-[#06D001] text-sm lg:text-base">Potensi Desa</p>
        </div>
    </div>
</div>
<!-- Breadcrumb End -->
...
<div class="max-w-full py-10 mx-7 my-12 bg-white overflow-hidden shadow-md rounded-md border">
    <div class="px-7 lg:px-20">
        <div class="bg-slate-50 flex items-center py-2 border-left shadow-md">
            <h1 class="text-xl uppercase text-[#06D001] px-6 font-bold lg:text-2xl">Potensi desa</h1>
        </div>
        ...
        <div class="flex flex-col lg:flex-row lg:justify-between py-10">
            <div class="w-full lg:w-[40%]" data-aos="fade-right" data-aos-diration="5000" data-aos-delay="200">
                <img src="admin-desa/img/<?= $d['gambar']; ?>" alt="" width="330" class="mx-auto rounded-md shadow-md">
            </div>
            <div class="w-full mt-5 lg:mt-0 lg:w-[80%]" data-aos="fade-left" data-aos-diration="5000" data-aos-delay="200">
                <div class="flex flex-col lg:justify-center lg:pl-10 mb-6">
                    <h1 class="text-xl font-bold text-[#06D001] lg:text-2xl mb-1"><?= $d['judul']; ?></h1>
                    <span class="text-sm font-semibold my-2 lg:text-base"><i class="mr-2 fa-solid fa-calendar-days"></i>Desa Pandan : <?= $d['tanggal']; ?></span>
                    <p class="text-xs text-slate-500 lg:text-base" id="text"><?= nl2br($d['deskripsi']); ?></p>
                </div>
                <a href="detail-potensi.php?potensi=<?= $d['judul']; ?>" class="lg:ml-10 px-3 py-2 bg-[#06D001] text-white rounded-lg font-semibold shadow-lg">Baca Selengkapnya</a>
            </div>
        </div>
        <?php endforeach; ?>
    </div>
