<?php
    ...
    $data = jabatan("SELECT * FROM berita ORDER BY id DESC");
...
<title>Berita Desa | Web Desa Pandan</title>
    ...
    <div class="px-7 lg:px-20">
        ...
        <div class="flex flex-col lg:flex-row lg:justify-between py-10">
            ...
            <div class="w-full mt-5 lg:mt-0 lg:w-[80%]" data-aos="fade-left" data-aos-diration="5000" data-aos-delay="200">
                ...
                <a href="detail-berita.php?berita=<?= $d['judul']; ?>" class="lg:ml-10 px-3 py-2 bg-[#06D001] text-white rounded-lg font-semibold shadow-lg">Baca Selengkapnya</a>
            </div>
        </div>
        <?php endforeach; ?>
    </div>
